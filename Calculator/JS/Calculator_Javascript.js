...
const Calculator = {
  ...
  First_Operand: null,
  // This checks whether or not the second has been inputted by the user
...
function Handle_Operator(Next_Operator) {
  ...
  if (First_Operand === null) {
    ...
    // If the operator already exists, property look up is performed for the operator
...
keys.addEventListener("click", (event) => {
  // The target variable is an objet that represents the element
  // that was clicked.
  const { target } = event;
